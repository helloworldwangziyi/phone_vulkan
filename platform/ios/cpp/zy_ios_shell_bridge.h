...
// ============================================================================
// iOS 壳层 ↔ core 的 C 桥接口。对照 Android 侧 ZyNativeBridge 的 JNI 方法表：
//
//   ZyNativeBridge.nativeInit(Surface)        → evkIosInit(CAMetalLayer*)
//   ZyNativeBridge.nativeResize(w, h)         → evkIosResize(w, h)
//   ZyNativeBridge.nativeBeginFrame(nanos)    → evkIosBeginFrame(nanos)
//   ZyNativeBridge.nativeOnTouch(...)         → evkIosTouch(...)
//   ZyNativeBridge.nativeDestroy()            → evkIosDestroy()
//
