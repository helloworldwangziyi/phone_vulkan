...
// 预编译 SPIR-V 字节码（assets::zy_ui_vert_spv / zy_ui_frag_spv），编译期内嵌进二进制，免运行时读文件。
#include "evk/assets/zy_ui_shaders.h"
...
bool Renderer::createGraphicsPipeline() {
    ...
    VkShaderModule vertModule = createShaderModule(
        assets::zy_ui_vert_spv, sizeof(assets::zy_ui_vert_spv));
    VkShaderModule fragModule = createShaderModule(
        assets::zy_ui_frag_spv, sizeof(assets::zy_ui_frag_spv));
